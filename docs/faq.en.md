...
This page answers common questions about installation, supported platforms, the bundled runtime, and plugins in the current stable release. The [latest GitHub Release](https://github.com/Qiuzixiao/deepseek-harness-desktop/releases/latest) and [user guide](user-guide.en.md) define the shipped product scope.
...
Download from the [GitHub Release page](https://github.com/Qiuzixiao/deepseek-harness-desktop/releases/latest). Check the [troubleshooting section](user-guide.en.md#troubleshooting) first. If the problem remains, open a [GitHub Issue](https://github.com/Qiuzixiao/deepseek-harness-desktop/issues/new/choose) with the operating system, app version, reproduction steps, and error details.
