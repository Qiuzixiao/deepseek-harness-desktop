...
export const REQUIRED_UNPACKED_RUNTIME_ENTRIES = [
  ...
  'resources/agent-presets/story-studio/agent.cordis.yml',
  'resources/agent-presets/story-studio/preset.yml',
  'resources/agent-presets/story-studio/skills/story-intake/SKILL.md',
  'resources/agent-presets/story-studio/skills/story-project/SKILL.md',
  'resources/agent-presets/story-studio/skills/story-project/scripts/story-project.mjs',
  'resources/agent-presets/story-studio/skills/short-drama-writing/SKILL.md',
  'resources/agent-presets/story-studio/skills/novel-writing/SKILL.md',
  'resources/agent-presets/story-studio/skills/reference-analysis/SKILL.md',
  'resources/agent-presets/story-studio/skills/story-review/SKILL.md',
  'node_modules/dsh-product-story-studio/package.json',
  ...
  'node_modules/@dsh-external/dsh-drop-to-path/lib/index.js',
  'node_modules/@dsh-external/dsh-drop-to-path/lib/client.js',
  'node_modules/@dsh-external/dsh-drop-to-path/LICENSE',
  'node_modules/dsh-rich-file-reader/package.json',
  'node_modules/dsh-rich-file-reader/cordis.patch.yml',
