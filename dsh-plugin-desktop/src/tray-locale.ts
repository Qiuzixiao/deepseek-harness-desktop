...
const labels: Record<DesktopLocale, Record<DesktopTrayLabelKey, (value: string) => string>> = {
  en: {
    ...
    downloadingUpdate: version => `Downloading Zenwit ${version}…`,
    ...
    updateAvailable: version => `Zenwit ${version} Available`,
  },
  zh: {
    addProfile: () => '添加配置…',
    checkForUpdates: () => '检查更新…',
    checkingForUpdates: () => '正在检查更新…',
    downloadingUpdate: version => `正在下载 Zenwit ${version}…`,
    ...
    updateAvailable: version => `Zenwit ${version} 可用`,
  },
}
