...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    manualConfigurationBody: 'Open only the active Profile paths selected by Zenwit.',
  ...
  zh: {
    ...
    manualConfigurationBody: '只打开由 Zenwit 确认的当前配置路径。',
...
export function RecoveryApp(): JSX.Element {
  ...
  if (state === undefined) return <main className="flex min-h-screen items-center justify-center p-6"><Alert variant="destructive"><AlertTriangle /><AlertTitle>Zenwit Recovery</AlertTitle><AlertDescription>The recovery state could not be read. Quit and start Zenwit again.</AlertDescription></Alert></main>
