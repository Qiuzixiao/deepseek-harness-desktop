...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\Zenwit\\Zenwit.exe',
  upstreamRunner: 'C:\\Program Files\\Zenwit\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\Zenwit\\resources\\app.asar\\desktop-runner.js',
}
