...
describe('published package surface', () => {
  it('pins the command Remote ABI at the RC2 three-argument boundary', () => {
    ...
    expect(linker).toContain("['@deepseek-ai/dsh-home-paths', 'packages/util/home-paths', ['lib/index.js', 'lib/invariant.js', 'lib/types']]")
  ...
  it('exposes the Host plugin and desktop-owned client face', () => {
    ...
    expect(readFileSync(new URL('cordis.patch.yml', packageRoot), 'utf8')).not.toContain('name: dsh-short-drama\n')
