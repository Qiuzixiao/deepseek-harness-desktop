...
describe('packaged dsh bootstrap', () => {
  ...
  it('clears Node mode before loading the fixed packaged CLI entry', async () => {
    ...
    const argv = ['/Applications/Zenwit', '/app.asar/lib/desktop-cli.js', '--dump-config']
  ...
  it('snapshots plugin installs launched from the built-in Terminal', async () => {
  ...
  it('uses the physical unpacked dependency tree only inside an Electron package', () => {
    expect(unpackedAsarPath('/Applications/Zenwit.app/Contents/Resources/app.asar/node_modules/pkg'))
      .toBe('/Applications/Zenwit.app/Contents/Resources/app.asar.unpacked/node_modules/pkg')
    expect(unpackedAsarPath('C:\\Program Files\\Zenwit\\resources\\app.asar\\node_modules\\pkg'))
      .toBe('C:\\Program Files\\Zenwit\\resources\\app.asar.unpacked\\node_modules\\pkg')
    expect(unpackedAsarPath('/Applications/Zenwit.app/Contents/Resources/app.asar/package.json'))
      .toBe('/Applications/Zenwit.app/Contents/Resources/app.asar.unpacked/package.json')
