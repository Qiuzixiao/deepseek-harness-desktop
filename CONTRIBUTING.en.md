...
- Report problems or odd behavior in an [issue](https://github.com/Qiuzixiao/deepseek-harness-desktop/issues): include your operating system (macOS / Windows), application version, and reproduction steps.
