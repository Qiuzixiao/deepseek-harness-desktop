...
| `dshHome` | `$DSH_HOME` or `~/.zenwit` | Zenwit config root resolved by [`@deepseek-ai/dsh-home-paths`](../../util/home-paths/README.md); scans `skills` under this directory. |
...
| Rank | Source | Path |
|---|---|---|
| 100 | `project-dsh` | `<projectRoot>/.zenwit/skills` |
