...
export function apply(ctx: Context): void {
  ...
  disposers.push(slots.register({ name: 'conversation.composer', select: selectApproval, priority: 1, locale: NS }, ApprovalPanel))
  ...
  disposers.push(slots.register({ name: 'conversation.composer.dock', id: 'stats', order: 0, locale: NS }, StatsLine))
    return disposers
  })
