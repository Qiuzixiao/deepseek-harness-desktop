...
export const zh = {
  ...
  'command.done': '已完成',
  'command.title': '命令',
  'execution.running': '正在处理',
  'execution.done': '已完成',
  'execution.tools': '{count} 次工具调用',
  'execution.thinking': '{count} 段思考',
  'execution.errors': '{count} 个错误',
  'execution.expand': '展开执行明细',
  'execution.collapse': '收起执行明细',
...
export const en = {
  ...
  'execution.tools': '{count} tool calls',
  'execution.thinking': '{count} thinking blocks',
  'execution.errors': '{count} errors',
  'execution.expand': 'Expand execution details',
  'execution.collapse': 'Collapse execution details',
