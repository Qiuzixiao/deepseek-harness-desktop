...
- only an exact stable npm target that passes independent registry, repository, integrity, bundle, deprecation, lifecycle-script, DSH 0.1.1-rc.1, and bundled Node.js checks may proceed;
