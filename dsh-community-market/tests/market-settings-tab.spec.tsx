...
describe('MarketSettingsTab', () => {
  ...
  it('previews an exact package and profile before install, executes only its preview id, and prompts for restart', async () => {
    ...
    expect(support.href).toBe('https://github.com/Qiuzixiao/deepseek-harness-desktop/issues')
  ...
  it('links failed install verification to the standard-plugin requirements', async () => {
    ...
    expect(details.href).toBe(
      'https://github.com/Qiuzixiao/deepseek-harness-desktop/blob/master/dsh-community-market/docs/install-and-uninstall.md',
    )
  ...
  it.skip('legacy configurable-source UI linked partner onboarding', async () => {
    ...
    expect(contact.href).toBe('https://github.com/Qiuzixiao/deepseek-harness-desktop/issues')
    ...
    expect(guide.href).toBe(
      'https://github.com/Qiuzixiao/deepseek-harness-desktop/blob/master/dsh-community-market/docs/catalog-adapter-guide.md',
    )
